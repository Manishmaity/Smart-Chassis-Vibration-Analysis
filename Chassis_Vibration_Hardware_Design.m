%% SMART CHASSIS VIBRATION ANALYSIS - HARDWARE DESIGN MODEL (MATLAB)
% Module-4 Project | Chassis Structures & Safety Telltales
%
% Models the complete hardware chain:
%   3x accelerometer -> anti-alias filter -> MCU ADC (+oversampling) ->
%   DSP features -> threshold + persistence logic -> LED telltale
% and calculates component values, power budget and MCU load.
%
% Needs base MATLAB only (no toolboxes). Local functions at the end of this
% file require MATLAB R2016b or newer. Run with the green "Run" button.
% NOTE: this is a design MODEL. Simulated vibration replaces a real car;
% component values are starting points - verify against datasheets.
